...
% -------------------------------------------------------------------------------------------------
\renewcommand{\thesistype}{} % default value: Thesis

% -------------------------------------------------------------------------------------------------
% Set names
% -------------------------------------------------------------------------------------------------
\renewcommand{\thesisauthor}{Marius Grimm}
\renewcommand{\thesisadviser}{Rebekka Burkholz}
\renewcommand{\thesisprof}{Prof. Dr. Dr. Frank Schweitzer}
\renewcommand{\thesisinstitut}{Chair of System Design}
\renewcommand{\thesisinstitutaddress}{}
\renewcommand{\thesisuni}{} % default value: Swiss Federal Institute of Technology Zurich (ETH)
\renewcommand{\thesisinstitutlogoname}{IRISlogo}
\renewcommand{\thesisunilogoname}{ETHlogo}
...
% ISO 8601
\thesistitlepage{Superb Thesis Title}{2015-05} 
