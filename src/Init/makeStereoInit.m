function p = makeStereoInit(parameters)
%MAKESTEREOINIT Summary of this function goes here
%   Detailed explanation goes here

p = @stereo_initialisation;

% Retrieve parameters
debug_with_figures = parameters.debug_with_figures;
triangulation_algorithm = parameters.triangulation_algorithm;
