function plotMap(hidden_state, range, num_frames, BA)
...
for i = 1:num_frames
   ...
   p_W_frames(:,i) = -T_W_frame(1:3,1:3)'*T_W_frame(1:3,4);
end
if (BA)
    title('Landmarks & Trajectory without BA')
else
    title('Landmarks & Trajectory with BA')
end
