...
S_i0 = struct('success', 0,...
    'keypoints_correspondences', keypoints,...
    'p_W_landmarks_correspondences', p_W_landmarks,...
    'candidate_keypoints', 0,...
    'candidates_transformation', 0,...
    'K', K);
S_i1 = struct('success', 0,...
    'keypoints_correspondences', 0,...
    'p_W_landmarks_correspondences', 0,...
    'candidate_keypoints', 0,...
    'candidates_transformation', 0,...
    'K', K);
